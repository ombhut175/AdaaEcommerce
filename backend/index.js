...
mongoose.connect(process.env.MONGO_URL)
    .then(() => {
        ...
        // initialize with firebase admin
        ...
        if (!firebaseProjectId || !firebaseClientEmail || !firebasePrivateKey) {
            ...
            if (!firebaseProjectId) console.error('  - FIREBASE_PROJECT_ID is not set');
            if (!firebaseClientEmail) console.error('  - FIREBASE_CLIENT_EMAIL is not set');
            if (!firebasePrivateKey) console.error('  - FIREBASE_PRIVATE_KEY is not set');
