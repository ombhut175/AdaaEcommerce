function Card_3() {
    return (
        <div className="m-5">
            <a href="#" className="group relative block bg-black rounded-lg overflow-hidden shadow-lg transform hover:scale-105 transition duration-300 ease-in-out sm:w-[280px] sm:h-[380px] lg:w-[500px] lg:h-[450px]">
