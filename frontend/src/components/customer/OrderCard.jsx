            ...
            <div className="flex justify-between mb-2">
                {statuses.map((s, index) => (
                    <div key={s} className="flex flex-col items-center w-1/3">
                        {index === 0 && (
                            <Package className={`w-5 h-5 ${index <= currentIndex ? "text-blue-500" : "text-gray-400"}`} />
                        )}
                        {index === 1 && (
                            <Truck className={`w-5 h-5 ${index <= currentIndex ? "text-blue-500" : "text-gray-400"}`} />
                        )}
                        {index === 2 && (
                            <CheckCircle className={`w-5 h-5 ${index <= currentIndex ? "text-blue-500" : "text-gray-400"}`} />
                        )}
