...
const FilterSystem = ({ priceRange, setPriceRange, filters, setFilters, uniqueValues, sortOrder, setSortOrder }) => {
    ...
    }, [filters, priceRange, sortOrder, searchParams]) // Added searchParams to dependencies
            ...
            {["colors", "size"].map((filterType) => (
                <motion.div key={filterType} layout>
                    ...
                    {filterType === "colors" ? (
                        ...
                        <div className="max-h-40 overflow-y-auto pr-2 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-2 lg:grid-cols-3 gap-2">
